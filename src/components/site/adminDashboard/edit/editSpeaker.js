...
function EditSpeaker() {
    ...
    function displayPhoto() {
        ...
        if (data.photo == null || data.photo[0] == null) {
            ...
            const imageBuffer = Buffer.from(data.photo[0].source.data);
            section.push(
                <div>
                    <img src={imageBuffer} alt={data.photo[0].name} width="150" height="150" responsive />
                    <p>
                        {data.photo[0].name}
                        <button className="deleteBtn " type="button" onClick={deleteFile('photo', 0)}><FaTrashAlt /></button>
                    </p>
        ...
        <>
            <form onSubmit={handleForm}>
                <div className="edit-form-container" style={{ marginTop: "5%", marginBottom: "5%" }}>
                    ...
                    <div className="form-group">
                        <label htmlFor="photo"><span>*</span>Photo</label><br />
                        {displayPhoto()}
                    </div>
                    <div className="form-group">
